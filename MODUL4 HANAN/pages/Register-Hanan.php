    ...
    if (isset($_POST["daftar"])) {
        ...
        $pwdConfirm = mysqli_real_escape_string($koneksiuser, $_POST["password2"]);
        $no_hp = $_POST["no"];
        $result = mysqli_query($koneksiuser, "SELECT email FROM user_hanan WHERE email = '$email'");

        if (mysqli_num_rows(($result)) !== 1 && $password == $pwdConfirm) {
            $password = password_hash($password, PASSWORD_DEFAULT);
            mysqli_query($koneksiuser, "INSERT INTO user_hanan (nama, email, password, no_hp) VALUES ('$nama', '$email', '$password', '$no_hp')");
            ...
            echo "<meta http-equiv='refresh' content='2 url=Login-Hanan.php'>";
    ...
    <head>
        <title>Register | Hanan_1202204042 </title>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-6 min-vh-100 left">
                        <img src="../asset/images/background.jpeg" style="object-fit:fill; width:100%; height:100%;" alt="foto">
                    </div>
                    <div class="col-md-6">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <div class="text-center text-lg-start mt-4 pt-2">
                                        ...
                                        <p class="small fw-bold mt-2 pt-1 mb-0">anda sudah punya akun? <a href="Login-Hanan.php" class="link-danger">Login</a></p>
                                    </div>
                            </form>
                        </div>
                    </div>
