  ...
  <head>
    ...
    <title>List Car | Hanan_1202204042</title>
          ...
          <div class="d-flex">
            ...
            <div class="dropdown ms-4">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "primary"; ?>" href="Profile-Hanan.php">Profile</a></li>
