    ...
    if (isset($_COOKIE["email"]) && isset($_COOKIE["password"])) {
        ...
        $result = mysqli_query($koneksiuser, "SELECT * FROM user_hanan WHERE email = '$email'");
    ...
    if (isset($_POST["log1n"])) {
        ...
        if (mysqli_num_rows($query) === 1) {
            ...
            if (password_verify($password, $data["password"])) {
                ...
                $_SESSION["login"] = true;
                $_SESSION["email"] = $data["email"];
                header("Location: List-Hanan.php");
                        ...
                        <div class="form-login m-auto ps-5">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="text-center text-lg-start mt-4 pt-2">
                                    ...
                                    <p class="small fw-bold mt-2 pt-1 mb-0">belum punya akun <a href="Register-Hanan.php" class="link-danger">Daftar</a></p>
                                </div>
                            </form>
                        </div>
