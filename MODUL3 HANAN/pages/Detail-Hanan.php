...
$sql = "SELECT * FROM showroom_hanan_table WHERE id_mobil = $id";
...
<head>
  ...
  <title>Detail Car | Hanan_1202204042</title>
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-Hanan.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
